...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></span> 
	...
	<!-- Flexslider -->
	<script src="<?php echo base_url();?>assets/Homepage/js/jquery.flexslider-min.js"></script>
	<!-- Owl carousel -->
	...
	<script src="<?php echo base_url();?>assets/Homepage/js/magnific-popup-options.js"></script>
	<!-- Date Picker -->
	<script src="<?php echo base_url();?>assets/Homepage/js/bootstrap-datepicker.js"></script>
	<!-- Stellar Parallax -->
	<script src="<?php echo base_url();?>assets/Homepage/js/jquery.stellar.min.js"></script>
	<!-- Main -->
