...
<html>
  ...
  <!-- Facebook and Twitter integration -->
	...
	<!-- Animate.css -->
	<link rel="stylesheet" href="<?php echo base_url();?>assets/Homepage/css/animate.css">
	<!-- Icomoon Icon Fonts-->
	<link rel="stylesheet" href="<?php echo base_url();?>assets/Homepage/css/icomoon.css">
	<!-- Bootstrap  -->
	<link rel="stylesheet" href="<?php echo base_url();?>assets/Homepage/css/bootstrap.css">

	<!-- Magnific Popup -->
	<link rel="stylesheet" href="<?php echo base_url();?>assets/Homepage/css/magnific-popup.css">

	<!-- Flexslider  -->
	<link rel="stylesheet" href="<?php echo base_url();?>assets/Homepage/css/flexslider.css">
	...
	<!-- Modernizr JS -->
	<script src="<?php echo base_url();?>assets/Homepage/js/modernizr-2.6.2.min.js"></script>
	<!-- FOR IE9 below -->
	<!--[if lt IE 9]>
